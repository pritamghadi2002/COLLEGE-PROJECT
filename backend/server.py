...
async def initialize_data():
    ...
    menu_items = [
        ...
        # Indian
        {"id": str(uuid.uuid4()), "name": "Butter Chicken", "category": "Indian", "price": 279, "availability": True, "image": "https://images.unsplash.com/photo-1708184528306-f75a0a5118ee?q=80&w=800&auto=format&fit=crop", "description": "Creamy tomato curry with chicken", "vegType": "non-veg"},
        {"id": str(uuid.uuid4()), "name": "Paneer Tikka", "category": "Indian", "price": 229, "availability": True, "image": "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?q=80&w=800&auto=format&fit=crop", "description": "Grilled cottage cheese with spices", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Biryani", "category": "Indian", "price": 299, "availability": True, "image": "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?q=80&w=800&auto=format&fit=crop", "description": "Aromatic rice with chicken and spices", "vegType": "non-veg"},
        
        # Odisha Special
        {"id": str(uuid.uuid4()), "name": "Pakhala Bhata", "category": "Odisha Special", "price": 149, "availability": True, "image": "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?q=80&w=800&auto=format&fit=crop", "description": "Traditional fermented rice with curd", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Dalma", "category": "Odisha Special", "price": 169, "availability": True, "image": "https://images.unsplash.com/photo-1546833999-b9f581a1996d?q=80&w=800&auto=format&fit=crop", "description": "Lentils with vegetables and mild spices", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Santula", "category": "Odisha Special", "price": 139, "availability": True, "image": "https://images.unsplash.com/photo-1601050690597-df0568f70950?q=80&w=800&auto=format&fit=crop", "description": "Mixed vegetable curry without oil", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Machha Besara", "category": "Odisha Special", "price": 249, "availability": True, "image": "https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?q=80&w=800&auto=format&fit=crop", "description": "Fish curry with mustard paste", "vegType": "non-veg"},
        {"id": str(uuid.uuid4()), "name": "Chingudi Malai Curry", "category": "Odisha Special", "price": 329, "availability": True, "image": "https://images.unsplash.com/photo-1633504581786-316c8002b1b9?q=80&w=800&auto=format&fit=crop", "description": "Prawn curry with coconut milk", "vegType": "non-veg"},
        {"id": str(uuid.uuid4()), "name": "Chuda Mixture", "category": "Odisha Special", "price": 89, "availability": True, "image": "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?q=80&w=800&auto=format&fit=crop", "description": "Flattened rice snack mix", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Enduri Pitha", "category": "Odisha Special", "price": 119, "availability": True, "image": "https://images.unsplash.com/photo-1626777639573-3f7cb1e83f50?q=80&w=800&auto=format&fit=crop", "description": "Rice cake with coconut and jaggery", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Chhena Poda", "category": "Odisha Special", "price": 159, "availability": True, "image": "https://images.unsplash.com/photo-1612182062366-efe3dd8c6c11?q=80&w=800&auto=format&fit=crop", "description": "Baked cottage cheese dessert", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Rasabali", "category": "Odisha Special", "price": 139, "availability": True, "image": "https://images.unsplash.com/photo-1606491956689-2ea866880c84?q=80&w=800&auto=format&fit=crop", "description": "Fried cheese patties in sweet syrup", "vegType": "veg"},
        
        # Desserts
        {"id": str(uuid.uuid4()), "name": "Chocolate Cake", "category": "Desserts", "price": 129, "availability": True, "image": "https://images.unsplash.com/photo-1673551490243-f29547426841?q=80&w=800&auto=format&fit=crop", "description": "Rich chocolate layer cake", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Cheesecake", "category": "Desserts", "price": 149, "availability": True, "image": "https://images.unsplash.com/photo-1524351199678-941a58a3df50?q=80&w=800&auto=format&fit=crop", "description": "Creamy New York style cheesecake", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Ice Cream", "category": "Desserts", "price": 99, "availability": True, "image": "https://images.unsplash.com/photo-1563805042-7684c019e1cb?q=80&w=800&auto=format&fit=crop", "description": "Assorted flavors", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Gulab Jamun", "category": "Desserts", "price": 109, "availability": True, "image": "https://images.unsplash.com/photo-1645177628172-a94c30a67536?q=80&w=800&auto=format&fit=crop", "description": "Traditional Indian sweet", "vegType": "veg"},
        
        # Drinks
        {"id": str(uuid.uuid4()), "name": "Fresh Juice", "category": "Drinks", "price": 79, "availability": True, "image": "https://images.unsplash.com/photo-1676105797000-323c37de780c?q=80&w=800&auto=format&fit=crop", "description": "Freshly squeezed juice", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Soft Drink", "category": "Drinks", "price": 59, "availability": True, "image": "https://images.unsplash.com/photo-1629203851122-3726ecdf080e?q=80&w=800&auto=format&fit=crop", "description": "Chilled soft drinks", "vegType": "veg"},
        {"id": str(uuid.uuid4()), "name": "Lassi", "category": "Drinks", "price": 79, "availability": True, "image": "https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?q=80&w=800&auto=format&fit=crop", "description": "Traditional yogurt drink", "vegType": "veg"},
